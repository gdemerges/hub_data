...
import { PageHeader, UnifiedTimeline } from '@/components'
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="motion-stagger grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        ...
        >
          <span
            className="gradient-mesh w-12 h-12 rounded-2xl border border-earth-fern/30 flex items-center justify-center shrink-0"
            style={
              {
          ...
          <div className="flex-1 min-w-0">
            <div className="font-display text-lg text-text-primary tracking-tight">
              Corrélations
            </div>
            <div className="text-sm text-text-secondary mt-1">
              Toutes les sections, année par année
            </div>
          </div>
          <span className="text-text-muted group-hover:text-earth-fern group-hover:translate-x-0.5 transition-all">
            →
          </span>
        </Link>
        <Link
        ...
        >
          <span
            className="gradient-mesh w-12 h-12 rounded-2xl border border-earth-terracotta/30 flex items-center justify-center shrink-0"
            style={
              {
                ['--mesh-a' as string]: '184 107 60',
          ...
          <span className="text-text-muted group-hover:text-earth-terracotta group-hover:translate-x-0.5 transition-all">
            →
          </span>
        </Link>
      </div>
