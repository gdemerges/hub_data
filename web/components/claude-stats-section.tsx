...
export function ClaudeStatsSection({ stats }: { stats: ClaudeStats }) {
  ...
  const dailyMax = Math.max(...stats.dailyActivity.map(d => d.messageCount), 1)
  const lastDays = stats.dailyActivity.slice(-30)
  ...
  return (
    <div className="tech-card p-6 mb-8">
      ...
      {/* Daily activity bar chart (30 derniers jours) */}
      <div className="mb-6">
